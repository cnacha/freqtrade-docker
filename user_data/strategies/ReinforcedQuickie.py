# freqtrade hyperopt --hyperopt-loss SharpeHyperOptLoss --spaces buy roi trailing sell --strategy ReinforcedQuickie
...
class ReinforcedQuickie(IStrategy):
    ...
    #hyperopt Parameters
    buy_mfi = IntParameter(low=10, high=100, default=30, space='buy', optimize=True)
    sell_mfi = IntParameter(low=10, high=100, default=80, space='sell', optimize=True)
    buy_rsi = IntParameter(low=10, high=100, default=30, space='buy', optimize=True)
    sell_rsi = IntParameter(low=10, high=100, default=70, space='sell', optimize=True)
